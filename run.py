...
def parse_args():
    ...
    args.add_argument('--task', type=str, required=True, choices=['game24', 'text', 'crosswords', 'design'])
    ...
    args.add_argument('--method_evaluate', type=str, choices=['value', 'vote', 'select'])
